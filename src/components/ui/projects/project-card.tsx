    ...
    return (
        <section 
            ...
            className={
                ...
                <Link href={`/projects/${props.project.id}`} className="inline-flex flex-col gap-4 ">
                    ...
                    <section className="mb-2 inline-flex flex-col justify-between gap-4">
                        <article className="text-white font-primary">
                            <h2 className="font-semibold mb-2 text-[1.25rem]">
                                {props.project.name}
                            </h2>
                            <span className="line-clamp-2  text-white/75">{props.project.description}</span>
                        </article>
            ...
            {/* <section className="w-full flex justify-center gap-3 border-t border-Customs-Card-Border py-4 mt-auto">
