...
>(({ className, ...props }, ref) => (
  <article
    ref={ref}
    className={cn(
      "w-full max-w-[27.125rem] h-full max-h-[35rem] aspect-[auto] flex-shrink-0 inline-flex flex-col items-start justify-start gap-4 p-3 md:p-4 rounded-xl border border-Customs-Card-Border bg-Customs-Card lg:shadow-[0px_0px_20px_0px_#2a4365] lg:hover:translate-y-[-0.5rem] transition-all duration-200 intersect-once lg:intersect:motion-scale-in-75 lg:intersect:motion-opacity-in-0",
      className
    )}
    {...props}
  />
