export const LinkedIn = ({color}) => {
    return (
        <svg fill={color} className="w-8 h-8 hover:scale-105 transition-all" xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" 
