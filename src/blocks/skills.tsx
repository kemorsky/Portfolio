            ...
            {/* <section className="flex justify-between w-full">
             ...
             <section className="flex justify-between w-full">
                ...
                <article aria-labelledby="skills-heading" className='flex flex-col gap-8'>
                    ...
                    <div className="w-full flex flex-col items-center justify-center gap-4 intersect-once md:intersect:motion-opacity-in-0 md:intersect:motion-translate-y-in-[-25%] ">
                        <h2 id="core-skills-heading" className='text-[1.125rem] font-semibold font-primary'>Core Skills</h2>
                    ...
                    <div className="w-full flex flex-col items-center justify-center gap-4 intersect-once md:intersect:motion-opacity-in-0 md:intersect:motion-translate-y-in-[-25%] ">
                        <h2 id="core-skills-heading" className='text-[1.125rem] font-semibold font-primary'>Currently Exploring</h2>
                        <section className="w-full flex flex-wrap justify-center gap-2">
                    ...
                    <div className="w-full flex flex-col items-center justify-center gap-4 intersect-once md:intersect:motion-opacity-in-0 md:intersect:motion-translate-y-in-[-25%] ">
                        <h2 id="core-skills-heading" className='text-[1.125rem] font-semibold font-primary'>Previously Worked With</h2>
                        <section className="w-full flex flex-wrap justify-center gap-2">
