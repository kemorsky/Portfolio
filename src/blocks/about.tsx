...
export default function About() {
    return (
        <div id="about" className="z-50 w-full flex flex-col gap-6 intersect-once md:intersect:motion-opacity-in-0 md:intersect:motion-translate-y-in-[25%]">
            ...
            <section className="w-full md:h-full inline-flex flex-col text-left gap-4 p-6 border-Customs-Card-Border bg-Customs-Card">
                <article>
                    <h2 className="text-[1.125rem] leading-[1.5rem] font-primary text-white">Hey, I&apos;m Kamil.</h2>
