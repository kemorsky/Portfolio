                ...
                <section className="w-full inline-flex flex-col items-start justify-center gap-4">
                    ...
                    <AboutCardFooter>
                        <section className="inline-flex items-center gap-1 text-2xl">
                            <Link className='w-10 h-10 hover:scale-110 transition-all duration-200 flex items-center justify-center rounded-[0.5rem] hover:bg-Customs-socialsButtons group' aria-label="LinkedIn" href="https://www.linkedin.com/in/kamil-romanowicz-52284b2a9/"><FaLinkedinIn className="text-white group-hover:animate-wiggle transform transition-transform duration-1000" /></Link>
                            <Link className='w-10 h-10  hover:scale-110 transition-all duration-200 flex items-center justify-center rounded-[0.5rem] hover:bg-Customs-socialsButtons group' href="https://github.com/kemorsky?tab=repositories"><FaGithub className="text-white group-hover:animate-wiggle transform transition-transform duration-1000" /></Link>
                            <a className="w-10 h-10 hover:scale-110 transition-all duration-200 flex items-center justify-center rounded-[0.5rem] hover:bg-Customs-socialsButtons group" href="mailto:kamil.romanowicz95@gmail.com"><AiOutlineMail className="text-white group-hover:animate-wiggle transform transition-transform duration-1000"/></a>
                        </section>
