    ...
    return (
        <Wrapper id="home" className="bg-transparent border-none mt-10 max-w-[50rem] md:intersect:motion-opacity-in-0 md:intersect:motion-translate-y-in-[-25%]">
            <section className="w-full flex flex-col items-start gap-4 self-start">
                ...
                <section className="w-full flex items-start justify-between text-left">
                    <article className="">
                        ...
                        <h2 className="text-xl font-primary font-medium">Frontend Developer by profession, Fullstack Developer by passion.</h2>
                    </article>
                    <article className="group w-full max-w-[17.5rem] py-2 px-3 rounded-2xl border border-Customs-Card-Border">
                        <p className="inline-block items-center justify-start group-hover:hidden transition-transform">Based in Gothenburg, Sweden 
                            <Image className="inline-block group-hover:hidden transition-transform ml-2" src={'/images/about/64px-Flag_of_Sweden.svg.png'} alt="sweden flag" width={32} height={24}/>
                        </p>
                        <p className="items-center justify-start hidden group-hover:inline-block transition-transform">But originally from Poland! 
                            <Image className="hidden group-hover:inline-block transition-transform ml-2" src={'/images/about/64px-Flag_of_Poland.svg.png'} alt="poland flag" width={32} height={24}/>
                        </p>
                    </article>
                </section>
                <span className="max-w-[30rem] text-xl font-primary text-white/70">
            ...
            <HeroCardFooter className="self-start">
                <a href="https://drive.google.com/file/d/1EiNme1FjTrRmUs3eQFrjHzG9UWHl3Xe1sNhEHKYnULQ/view" aria-label="Navigate to CV" download>
                    <Button variant="hire-me" size="default">Resume<Download/></Button>
                </a>
