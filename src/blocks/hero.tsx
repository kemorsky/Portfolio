            ...
            <HeroCard>
                ...
                <section className="w-full inline-flex flex-col items-start justify-center gap-4">
                    <section className="inline-flex flex-col items-start justify-center gap-1.5">
                        ...
                        <HeroCardDescription>I&apos;m a Front End student currently seeking employment. I like to bring designs to life and learn new ways of coding websites and applications.</HeroCardDescription>
                    </section>
                    <HeroCardFooter>
