    ...
    return (
        <Wrapper id="home" className="bg-transparent border-none pt-10 max-w-[50rem] md:intersect:motion-opacity-in-0 md:intersect:motion-translate-y-in-[-25%]">
            ...
            <section className="sm:flex-row flex-col inline-flex items-start sm:items-center justify-start gap-4 self-start">
                ...
                <section className="inline-flex items-center gap-2 text-2xl">
                    <Link className='group/follow w-8 h-8 hover:scale-110 transition-all duration-200 flex items-center justify-center rounded-[0.5rem] hover:bg-Customs-socialsButtons' 
                    ...
                    <a className="group/follow w-8 h-8 hover:scale-110 transition-all duration-200 flex items-center justify-center rounded-[0.5rem] hover:bg-Customs-socialsButtons" 
                ...
                <section className="flex gap-4">
                    ...
                    <Link className="max-w-[14rem] h-8 group/follow w-full py-2 px-3 hover:scale-105 transition-all duration-200 inline-flex items-center gap-1 rounded-[0.5rem] hover:bg-Customs-socialsButtons" 
