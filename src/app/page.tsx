...
export default function Home() {
  return (
    <ObserverProvider>
      <div className="flex items-center justify-center mih-h-screen scroll-smooth overflow-hidden">
        <main className="z-45 w-full flex flex-col items-center px-4 lg:px-0 gap-8 justify-start relative mt-[7rem]">
          <div className="z-40 max-w-[90rem] w-full flex flex-col items-start justify-center gap-12 sm:gap-20 md:gap-32 relative">
